...
def classification():
	...
	dataf = pd.read_csv(os.path.join('static', 'datasetlog', "Datasetinfectedhealthy.csv"))
	...
	log = pd.read_csv("static/datasetlog/Datasetunlabelledlog.csv")
	...
	if(Sum < 2):
		...
		return "The leaf is sufficiently healthy!"
	else:
		return "The leaf is infected!"
