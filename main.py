...
def prediction(image):
	...
	cv2.imwrite(os.path.join('static', 'analytics', 'original.jpg'), img)
	...
	cv2.imwrite(os.path.join('static', 'analytics', 'neworiginal.jpg'), neworiginal)
	...
	cv2.imwrite(os.path.join('static', 'analytics', 'frame.jpg'), frame)
	#cv2.imshow('rectangle ROI', roi)
	cv2.imwrite(os.path.join('static', 'analytics', 'roi.jpg'), roi)
	img = roi
	...
	cv2.imwrite(os.path.join('static', 'analytics', 'imghls.jpg'), imghls)
	...
	cv2.imwrite(os.path.join('static', 'analytics', 'huehls.jpg'), huehls)	
	...
	cv2.imwrite(os.path.join('static', 'analytics', 'thresh.jpg'), thresh)
	...
	for x in range(len(contours)):
		...
		cv2.imwrite(os.path.join('static', 'analytics', 'originalroi.jpg'), originalroi)
	...
	filename = 'static/datasetlog/Datasetunlabelledlog.csv' 
	while True:	
